...
CFLAGS += -DHUBBLE_TIME_S=$(shell date +%s)
...
CFLAGS += -I. \
	  ...
	  "-I$(SIMPLELINK_LOWPOWER_F3_SDK_INSTALL_DIR)/source/ti/common/cc23xx" \
...
syscfg: hubble.syscfg $(BUILD_DIR)
...
syscfg-gui: hubble.syscfg $(SYSCONFIG_GUI_TOOL)
...
HUBBLENETWORK_SDK_CONFIG = $(abspath src/hubble_config.h)
include $(HUBBLE_NETWORK_SDK)/port/freertos/hubblenetwork-sdk.mk


OBJECTS += $(BUILD_DIR)/app_hubble_ble_ti.obj $(patsubst %.c,$(BUILD_DIR)/%.obj,$(notdir $(HUBBLENETWORK_SDK_SOURCES)))
